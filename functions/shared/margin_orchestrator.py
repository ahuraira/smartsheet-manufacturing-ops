...
class MarginOrchestrator:
    ...
    def trigger_margin_approval_for_tag(self, tag_sheet_id: str, delivered_sqm: float, lpo_sap_ref: str, trace_id: str) -> Optional[Dict[str, Any]]:
        ...
        row_data = {
            ...
            Column.MARGIN_APPROVAL_LOG.ACCESSORY_COST: metrics["fixed_cost_aed"] + metrics["credit_risk_aed"],
            Column.MARGIN_APPROVAL_LOG.EQ_ACCESSORY_SQM: metrics["delivered_sqm"],
