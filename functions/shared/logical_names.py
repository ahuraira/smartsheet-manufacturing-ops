...
class Column:
    ...
    class LPO_MASTER:
        ...
        CLIENT_REQUEST_ID = "CLIENT_REQUEST_ID"
        CREATED_BY = "CREATED_BY"  # Note: Manifest has CREATED_BY not CREATED_AT
        UPDATED_AT = "UPDATED_AT"
        UPDATED_BY = "UPDATED_BY"
        # Additional columns from manifest
        ESTIMATED_IN_PRODUCTION_3_DAYS = "ESTIMATED_IN_PRODUCTION_3_DAYS"
