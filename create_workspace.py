...
SHEET_DEFINITIONS = {
    ...
    "99 Exception Log": {
        ...
        "columns": [
            ...
            {"title": "Source", "type": "PICKLIST", "options": ["Parser", "Allocation", "Reconcile", "Manual", "SAP Sync"]},
            {"title": "Related Tag ID", "type": "TEXT_NUMBER"},
            {"title": "Related Txn ID", "type": "TEXT_NUMBER"},
            {"title": "Material Code", "type": "TEXT_NUMBER"},
            {"title": "Quantity", "type": "TEXT_NUMBER"},
            {"title": "Reason Code", "type": "PICKLIST", "options": ["DUPLICATE_UPLOAD", "MULTI_TAG_NEST", "SHORTAGE", "OVERCONSUMPTION", "PHYSICAL_VARIANCE", "SAP_CREATE_FAILED", "PICK_NEGATIVE"]},
